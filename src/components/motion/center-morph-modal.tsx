          ...
          {(isPresent) => (
            ...
            >
              <motion.button
                ...
                className={cn(
                  "pointer-events-auto absolute inset-0 h-full w-full cursor-default bg-background/20 backdrop-blur-md",
                  backdropClassName,
                )}
              />
              ...
              <div className="pointer-events-none absolute inset-0 flex items-center justify-center overflow-y-auto p-4 drop-shadow-2xl">
                <div className="flex w-full flex-col items-center py-8">
                  <motion.div
                    ...
                    className={cn(
                      "pointer-events-auto relative w-full max-w-[46rem] origin-center overflow-hidden rounded-[36px] border border-gray-200 bg-white shadow-2xl will-change-[clip-path]",
                      className,
                    )}
                  >
                    {children}
                    ...
                    {showCloseButton ? (
                      <motion.button
                        ...
                        className="absolute right-5 top-5 inline-flex h-9 w-9 items-center justify-center rounded-full bg-black/5 text-gray-500 transition-colors hover:bg-black/10 hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black z-50"
                      >
