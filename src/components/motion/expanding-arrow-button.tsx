...
>(function ExpandingArrowButton(
  ...
  return (
    <motion.button
      ...
      className={cn(
        "relative inline-flex h-12 min-w-[170px] items-center overflow-hidden rounded-[50px] bg-neutral-950 p-1.5 text-white select-none shadow-md cursor-pointer",
        "outline-none focus-visible:ring-2 focus-visible:ring-[#ff6e20] focus-visible:ring-offset-2 focus-visible:ring-offset-background",
    ...
    >
      <motion.span
        ...
        style={{
          width: active ? "calc(100% - 10px)" : 38,
          borderRadius: 20,
        }}
        className={cn(
          "absolute inset-y-1 left-1 z-10 overflow-hidden bg-[#ff6e20] text-neutral-950",
          accentClassName,
        )}
      >
        <motion.span
      ...
      <motion.span
        ...
        className={cn(
          "relative z-0 ml-[52px] mr-4 whitespace-nowrap text-sm font-semibold tracking-[-0.02em]",
          labelClassName,
        )}
      >
        {children}
